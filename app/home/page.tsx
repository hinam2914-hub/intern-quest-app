...
export default function HomePage() {
  ...
  const isDark = false; // 背景は明るい昼、UIは紫ダーク
  const bg = "radial-gradient(circle at 78% 12%, rgba(255,255,255,.55), transparent 42%), linear-gradient(180deg, #7cc5f0 0%, #a9dcf5 45%, #cfeafb 100%)";
