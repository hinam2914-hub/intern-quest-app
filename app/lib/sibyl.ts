...
export function getEducationSibyl(education: string): { cog: number; grit: number } {
    ...
    if (/大東文化|東海大学|亜細亜|帝京|国士舘|神奈川大学|工学院|東京電機|拓殖|玉川|東京経済|東京都市|立正|大妻|実践女子|共立女子|昭和女子|東京女子|日本女子|津田塾|学習院女子|桜美林|関東学院|文教|順天堂|明星|武蔵野大学|杏林|東京農業|二松学舎|白百合|聖心|フェリス/.test(e)) return { cog: 5, grit: 3 };
