    ...
    return (
        <div style={{ minHeight: "100vh", background: bg, padding: "32px 20px", transition: "background 0.3s" }}>
            <div style={{ maxWidth: 680, margin: "0 auto" }}>
                <div onClick={() => router.push("/home")} style={{ fontSize: 12, color: accent, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", cursor: "pointer", display: "inline-block" }}>INTERN QUEST</div>
