...
const QUESTIONS = [{"section": "Part①: 保身思考編", "q": "Q1. 成長を止めやすい思考として近いのは？", "options": ["A. 挑戦する", "B. ミスを認める", "C. 自分を守ることを優先する", "D. 行動する"], "correct": 2}, {"section": "Part①: 保身思考編", "q": "Q2. \"保身が強い人\"に多い特徴は？", "options": ["A. 素直", "B. 他責・言い訳が増える", "C. 行動力ある", "D. 明るい"], "correct": 1}, {"section": "Part①: 保身思考編", "q": "Q3. 本当に強い人の特徴として近いのは？", "options": ["A. ミスしない", "B. 責任から逃げない", "C. 自信ある", "D. 圧が強い"], "correct": 1}, {"section": "Part①: 保身思考編", "q": "Q4. 「でも自分は悪くないです」が危険な理由は？", "options": ["A. 偉そうだから", "B. 暗いから", "C. 改善機会を失うから", "D. 空気悪いから"], "correct": 2}, {"section": "Part①: 保身思考編", "q": "Q5. 保身が強い人に起きやすいことは？", "options": ["A. 信頼増える", "B. 行動量増える", "C. 成長が止まる", "D. 人脈増える"], "correct": 2}, {"section": "Part①: 保身思考編", "q": "Q6. 指摘された時に最も重要なのは？", "options": ["A. 言い返す", "B. 自分守る", "C. 誰の責任か探す", "D. 改善できる部分を探す"], "correct": 3}, {"section": "Part①: 保身思考編", "q": "Q7. \"責任感ある人\"に近いのは？", "options": ["A. ミス隠す人", "B. 言い訳多い人", "C. 自分ごととして考える人", "D. 空気読む人"], "correct": 2}, {"section": "Part①: 保身思考編", "q": "Q8. 保身で問題が悪化する理由は？", "options": ["A. 暗いから", "B. 本質から逃げるから", "C. 真面目だから", "D. 気まずいから"], "correct": 1}, {"section": "Part①: 保身思考編", "q": "Q9. 社会で信頼される人の特徴は？", "options": ["A. ミスしない", "B. 自分を守る", "C. 問題と向き合う", "D. 話うまい"], "correct": 2}, {"section": "Part①: 保身思考編", "q": "Q10. \"成長できる人\"に必要なのは？", "options": ["A. プライド", "B. 完璧さ", "C. 自分を客観視する力", "D. 圧力"], "correct": 2}, {"section": "Part②: ケーススタディ", "q": "Q11. ミスした時に最も危険なのは？", "options": ["A. 謝る", "B. 落ち込む", "C. 隠す・ごまかす", "D. 相談する"], "correct": 2}, {"section": "Part②: ケーススタディ", "q": "Q12. 「自分は悪くない」が続く人に多いのは？", "options": ["A. 優しい", "B. 行動力ある", "C. 他責思考", "D. 真面目"], "correct": 2}, {"section": "Part②: ケーススタディ", "q": "Q13. 成長が早い人は指摘後どうする？", "options": ["A. 即改善する", "B. 言い訳する", "C. 空気読む", "D. 感情的になる"], "correct": 0}, {"section": "Part②: ケーススタディ", "q": "Q14. \"保身文化\"が強い組織に起きやすいことは？", "options": ["A. 成長加速", "B. 問題共有減る", "C. 信頼増える", "D. 行動量増える"], "correct": 1}, {"section": "Part②: ケーススタディ", "q": "Q15. 本当に必要なのは？", "options": ["A. 自分を守ること", "B. 責任回避", "C. 見栄", "D. 改善と再発防止"], "correct": 3}];

const WRITTEN_QUESTIONS = ["Q16. 最近、自分が\"保身に走った\"と思う経験を書いてください", "Q17. 「保身が強い人」の特徴を書いてください", "Q18. 自分が言い訳しやすい場面を書いてください", "Q19. \"責任感が強い人\"の特徴を書いてください", "Q20. 保身を減らすために必要なことを書いてください", "Q21. 今の自分が\"逃げている部分\"を書いてください"];

const TEST_CONFIG = {
    type: "self_protection",
    title: "🛡️ 保身・自己防衛過剰改善",
    color: "#a855f7",
    passedField: "self_protection_passed",
    rewardPoints: 10,
};
...
export default function TestPage() {
    ...
    const handleSubmit = async () => {
        ...
        if (passedSelection) {
            ...
            await supabase.from("points_history").insert({ user_id: userId, change: TEST_CONFIG.rewardPoints, reason: "保身防止テスト合格" });
