    ...
    if (alreadyPassed) return (
        <main style={{ minHeight: "100vh", background: "#0a0a0f", padding: "40px 24px 80px", fontFamily: "'Inter', sans-serif" }}>
            <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
                ...
                <h1 style={{ fontSize: 28, fontWeight: 800, color: "#06b6d4", margin: "0 0 12px" }}>満点合格済み</h1>
                <p style={{ color: "#9ca3af", fontSize: 14, marginBottom: 32 }}>あなたはすでにマーケター適性満点合格に認定されています</p>
