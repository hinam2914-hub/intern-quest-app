...
const QUESTIONS = [{"section": "Part①: 論理思考編", "q": "Q1. 議論で最も重要なのは？", "options": ["A. 声の大きさ", "B. 自信", "C. 感情", "D. 根拠"], "correct": 3}, {"section": "Part①: 論理思考編", "q": "Q2. 「でも自分はこう思います」を繰り返す人の問題は？", "options": ["A. 自信が強い", "B. 個性ある", "C. 根拠不足になりやすい", "D. 熱量ある"], "correct": 2}, {"section": "Part①: 論理思考編", "q": "Q3. 論理が弱い人に多い特徴は？", "options": ["A. 行動力ある", "B. 感情で話す", "C. 明るい", "D. 自信ある"], "correct": 1}, {"section": "Part①: 論理思考編", "q": "Q4. 「なんとなく違う気がする」が弱い理由は？", "options": ["A. 暗いから", "B. 空気悪いから", "C. 抽象的で検証できないから", "D. ネガティブだから"], "correct": 2}, {"section": "Part①: 論理思考編", "q": "Q5. 本当に強い人の特徴は？", "options": ["A. 圧が強い", "B. 感情をぶつける", "C. 冷静に整理できる", "D. 口数多い"], "correct": 2}, {"section": "Part①: 論理思考編", "q": "Q6. 議論で\"負けてる人\"に多い行動は？", "options": ["A. 質問する", "B. 整理する", "C. 話を逸らす", "D. 要点まとめる"], "correct": 2}, {"section": "Part①: 論理思考編", "q": "Q7. 「いや普通に考えて」は論理として弱い理由は？", "options": ["A. 偉そうだから", "B. 感覚論だから", "C. 雰囲気悪いから", "D. 長いから"], "correct": 1}, {"section": "Part①: 論理思考編", "q": "Q8. 論理力が高い人はどう話す？", "options": ["A. 感情を強く出す", "B. 勢いで押す", "C. 結論→理由→具体例で話す", "D. 長く話す"], "correct": 2}, {"section": "Part①: 論理思考編", "q": "Q9. 感情論に逃げやすい人の特徴は？", "options": ["A. 優しい", "B. 根拠整理が苦手", "C. 行動力ある", "D. 負けず嫌い"], "correct": 1}, {"section": "Part①: 論理思考編", "q": "Q10. 「それってなぜ？」に答えられない状態は？", "options": ["A. 普通", "B. 若いから仕方ない", "C. 論理不足", "D. 経験不足"], "correct": 2}, {"section": "Part②: ケーススタディ", "q": "Q11. 「なんか嫌です」と言うだけでは弱い理由は？", "options": ["A. ネガティブだから", "B. 雰囲気悪いから", "C. 原因が分からないから", "D. 子供っぽいから"], "correct": 2}, {"section": "Part②: ケーススタディ", "q": "Q12. 議論中に声が大きくなる人に多いのは？", "options": ["A. 情熱", "B. 自信", "C. 整理不足", "D. 行動力"], "correct": 2}, {"section": "Part②: ケーススタディ", "q": "Q13. 「自分はこういうタイプなんで」の問題点は？", "options": ["A. 暗い", "B. 個性強い", "C. 改善放棄になりやすい", "D. 真面目すぎる"], "correct": 2}, {"section": "Part②: ケーススタディ", "q": "Q14. 論理的に話せる人の特徴は？", "options": ["A. 感情ない", "B. IQ高い", "C. 話を整理できる", "D. 無口"], "correct": 2}, {"section": "Part②: ケーススタディ", "q": "Q15. 感情論から抜け出すために必要なのは？", "options": ["A. 気合い", "B. 根性", "C. 自信", "D. 分解して考える習慣"], "correct": 3}];

const WRITTEN_QUESTIONS = ["Q16. 最近、自分が\"感情で話してしまった\"経験を書いてください", "Q17. 「論理が弱い人」の特徴を書いてください", "Q18. 「自分はこう思う」を論理的に説明するには何が必要か書いてください", "Q19. 最近納得できなかったことを、\"感情\"ではなく\"構造\"で説明してください", "Q20. 論理的に話せる人の特徴を書いてください", "Q21. 今の自分が\"勢いでごまかしている部分\"を書いてください"];

const TEST_CONFIG = {
    type: "logical_thinking",
    title: "🧮 論理思考・感情逃避防止",
    color: "#6366f1",
    passedField: "logical_thinking_passed",
    rewardPoints: 10,
};
...
export default function TestPage() {
    ...
    const handleSubmit = async () => {
        ...
        if (passedSelection) {
            ...
            await supabase.from("points_history").insert({ user_id: userId, change: TEST_CONFIG.rewardPoints, reason: "論理思考テスト合格" });
